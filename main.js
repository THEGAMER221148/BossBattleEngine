...
import AttackBox from "./engine/AttackBox.js";
...
setCanvasSize(960, 720); // This sets the resolution of the canvas, the main part of the screen where sprites show up.

// Put initialization stuff (charcter definitions, etc.) here!
const boss = new Sprite(["./images/LQBBE-Logo.png"], 480, 100, 200, 200, 0);
boss.visible = false;
const voice1 = "./sounds/chirp.wav";
const attackBox = new AttackBox(480, 360, 200, 200, "./images/player.png", 0.25, 2);
